        ...
        try:
            ...
            if is_session_exists > 0:
                return Result.failure(
                    message=SessionChatResult.SESSION_ALREADY_EXISTS.message,
                    code=SessionChatResult.SESSION_ALREADY_EXISTS.code,
                )
            ...
            return Result.success(
                message=SessionChatResult.SESSION_CREATED.message,
                code=SessionChatResult.SESSION_CREATED.code,
            )
